...
contract IdentityManagement
{
    ...
    */
    ...
    function AddUserDL(address UserAddress,string memory _DL_No, string memory _DL_Name, string memory _DL_DOB, bytes memory DL_Hash, string memory DL_Address) public
    {
        UserDLMap[UserAddress].push(UserDL(_DL_No, _DL_Name, _DL_DOB, DL_Hash, DL_Address));
    }
    ...
    function viewUserDL(address UserAddress, uint RequestIndex) view public returns(uint DL_No_S, string memory _DL_No_V, uint DL_Name_S, string memory DL_Name_V, uint DL_DOB_S, string memory _DL_DOB_V, uint DL_Hash_S, bytes memory DL_Hash_V, uint DL_Address_S, string memory DL_Address_V)
    {
